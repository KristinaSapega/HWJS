...
//вариант 0.
const clientDeviceYear = 2023; // год создания устройства клиента
const clientDeviceOS = 'Android'; // операционная система устройства клиента

if (clientDeviceYear >= 2015) {
  console.log('Установите приложение для ' + clientDeviceOS + ' по ссылке');
} else if (clientDeviceOS === 'iOS') {
  console.log('Установите облегченную версию приложения для ' + clientDeviceOS + ' по ссылке');
} else if (clientDeviceOS === 'Android') {
  console.log('Установите облегченную версию приложения для ' + clientDeviceOS + ' по ссылке');
} else {
